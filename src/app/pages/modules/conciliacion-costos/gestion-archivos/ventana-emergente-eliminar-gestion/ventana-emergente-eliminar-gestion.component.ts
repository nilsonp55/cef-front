...
@Component({
  selector: 'app-ventana-emergente-eliminar-gestion',
  templateUrl: './ventana-emergente-eliminar-gestion.component.html',
  styleUrls: ['./ventana-emergente-eliminar-gestion.component.css']
})
export class VentanaEmergenteEliminarGestionComponent implements OnInit {
  observacion: any;

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialog: MatDialog,
    private dialogRef: MatDialogRef<VentanaEmergenteEliminarGestionComponent>,
