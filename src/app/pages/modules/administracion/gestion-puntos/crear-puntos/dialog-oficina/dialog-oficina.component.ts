...
export class DialogOficinaComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    if (this.data.flag == "info") {
      ...
      this.form.get('programaTransporte').disable();
  ...
  initForm(param?: any) {
    this.form = new FormGroup({
      ...
      'programaTransporte': new FormControl(param.oficinas != undefined ? param != null ? param.oficinas.programaTransporte : null : null),
  ...
  persistir() {
    ...
    let oficina = {
      ...
      programaTransporte: this.form.value['programaTransporte'],
