...
export class ConciliacionProcesamientoGuard implements CanActivate {
  ...
  canActivate(
    ...
    return new Promise((resolve, reject) => {
      this.rolMenuService.obtenerUsuarios({
        ...
        //Logica para capturar los menus
        ...
        this.rolMenuService.obtenerMenuRol({
          ...
          menusrol.data.forEach(itm => {
            if (itm.menu.url == "conciliacion-procesamiento") {
              guardOk = true;
            }
          });
          if (guardOk) {
            ...
            this.router.navigate(['/conciliacion-costos']);
            resolve(false);
          }
        });
      })
