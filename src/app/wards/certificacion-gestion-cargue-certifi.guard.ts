...
export class CertificacionGestionCargueCertificacionGuard implements CanActivate {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.rolMenuService.obtenerUsuarios({
        ...
        this.rolMenuService.obtenerMenuRol({
          ...
          menusrol.data.forEach(itm => {
            if (itm.menu.url == "gestion-cargue-certificacion") {
              guardOk = true;
            }
          });
          if (guardOk) {
            ...
            this.router.navigate(['/cargue-certificacion']);
            resolve(false);
          }
        });
      })
